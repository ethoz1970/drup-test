...
class EntityReference_SelectionHandler_Generic implements EntityReference_SelectionHandler {
  ...
  public static function settingsForm($field, $instance) {
    //echo "<pre>".__FILE__.'<br>'.__METHOD__.' : '.__LINE__."<br><br>"; var_dump( $field, $instance ); exit;
  ...
  public function getReferencableEntities($match = NULL, $match_operator = 'CONTAINS', $limit = 0) {
    //echo "<pre>".__FILE__.'<br>'.__METHOD__.' : '.__LINE__."<br><br>"; var_dump( debug_backtrace() ); exit;
...
class EntityReference_SelectionHandler_Generic_taxonomy_term extends EntityReference_SelectionHandler_Generic {
   ...
   */
  public function getReferencableEntities($match = NULL, $match_operator = 'CONTAINS', $limit = 0) {
    echo "<pre>".__FILE__.'<br>'.__METHOD__.' : '.__LINE__."<br><br>"; var_dump( 'getReferencableEntities' ); exit;
